...
筆者はRとPythonを使いますが、[こちらのGithubのリポジトリに利用するファイルをすべて置いて](https://github.com/ryouen/ryouen.github.io/tree/master/stat)おきます。環境構築には、Rは[R 3.5.2](https://cran.r-project.org/src/base/R-3) と、[RStudio](https://www.rstudio.com/products/rstudio/download/)、Pythonは[Anaconda](https://docs.anaconda.com/anaconda/install/)のJupyter Notebookを使っています。
